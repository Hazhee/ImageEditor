...
@section('content')
    <div class="container text-center mt-5">
        ...
        <a href="{{url('https://elijahimageeditor-bf08cb0934b4.herokuapp.com/download/'.$editedImagePath)}}" id="downloadLink" class="btn btn-success" style="d">Download Edited Image</a> <br> <br>
